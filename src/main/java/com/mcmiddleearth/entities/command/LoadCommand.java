...
import com.mcmiddleearth.entities.command.argument.LoadedEntitiesFilesArgument;
...
public class LoadCommand extends McmeEntitiesCommandHandler {
    ...
    protected HelpfulLiteralBuilder createCommandTree(HelpfulLiteralBuilder commandNodeBuilder) {
        commandNodeBuilder
                ...
                .then(HelpfulRequiredArgumentBuilder.argument("file", new LoadedEntitiesFilesArgument())
                        .executes(context -> this.loadEntities(context.getSource(), context.getArgument("file", String.class))));
        return commandNodeBuilder;
    }

    private int loadEntities(McmeCommandSender sender, String fileName) {
        final File file = new File(EntitiesPlugin.getEntitiesFolder(), fileName + ".json");
